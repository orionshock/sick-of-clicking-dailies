	...
	local options = {
		...
		args = {
			faction = { name = "Factions", type = "group", order = 1,
				args = {
					wyrmrestAccord = { name = L["The Wyrmrest Accord"], type = "multiselect", order = 1,
						values = { LQ["Aces High!"], LQ["Drake Hunt"], LQ["Defending Wyrmrest Temple"] },
					},
					sholizar = { name = L["Sholazar Basin"], type = "group", order = 2,
						args = {
							Oracles = { name = L["The Oracles"], type = "multiselect", order = 1, inline = true,
							...
							Frenzyheart = { name = L["Frenzyheart Tribe"], type = "multiselect", order = 2, inline = true,
					...
					Hodir = { name = L["The Sons of Hodir"], type = "multiselect", order = 3,
					...
					Crusade = { name = L["Argent Crusade"], type = "multiselect", order = 4,
						values = { 
							LQ["The Alchemist's Apprentice"], 
							LQ["Troll Patrol"], 
					...
					Ebon = { name = L["Knights of the Ebon Blade"], type = "multiselect", order = 5,
					...
					Kalu = { name = L["The Kalu'ak"], type = "multiselect", order = 6,
						values = { LQ["Planning for the Future"], LQ["Preparing for the Worst"], LQ["The Way to His Heart..."], },
					},
					peaks = { name = L["The Storm Peaks"], type = "multiselect", order = 7,
			...
			shared = { name = L["Shared Faction Quests"], type = "group", order = 2,
				args = {
					ice = {	name = L["Icecrown"], type = "multiselect", order = 1,
					...
					hills = { name = L["Grizzly Hills"], type = "multiselect", order = 2,
...
function module:GetWorldPvP()
	local t = { name = L["World PvP"], type = "group", order = 3,
		args = {
			wintergrasp = { name = L["Wintergrasp"], order = 1, type = "multiselect",
			...
			iceCrown = { name = L["Icecrown"], order = 2, type = "group",
				args = {
					Netural = {name = "Icecrown Netural Quests", type = "multiselect", order = 1, values = {},},			
					IceHorde = { name = L["Horde"], type = "multiselect", order = 2,
						values = { LQ["Make Them Pay!"], LQ["Shred the Alliance"] },
						hidden = function(info) return select(2, UnitFactionGroup("player")) == "Alliance" end

					},
					IceAlliance = { name = L["Alliance"], type = "multiselect", order = 2,
			...
			hills = { name = L["Grizzly Hills"], type = "group", order = 3,
				args = {
					netural = { name = L["Shared Quests"], type = "multiselect", order = 1,
						values = { LQ["Keep Them at Bay"], LQ["Riding the Red Rocket"], LQ["Seared Scourge"], LQ["Smoke 'Em Out"], },
					},
					horde = {name = L["Horde"], type = "multiselect", order = 2,
						values = { LQ["Crush Captain Brightwater!"], LQ["Keep 'Em on Their Heels"], LQ["Blackriver Brawl"], },
					},
					alliance = { name = L["Alliance"], type = "multiselect", order = 3,
						values = { LQ["Down With Captain Zorna!"], LQ["Kick 'Em While They're Down"], LQL["Blackriver Skirmish"], },
					},
				},
			},
		},
