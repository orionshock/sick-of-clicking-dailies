...
local L = LibStub("AceLocale-3.0"):NewLocale(addonName, "ruRU", true, debug)
...
local GT = LibStub("AceLocale-3.0"):NewLocale(addonName.."GossipText", "ruRU", true, debug)
	if GT then

--@localization(locale="ruRU", format="lua_additive_table", same-key-is-true=true, namespace="GossipText", table-name="GT")@
