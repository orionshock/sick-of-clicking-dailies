...
local L = LibStub("AceLocale-3.0"):NewLocale("SOCD_Core", "ruRU", false)
...
--@localization(locale="ruRU", format="lua_additive_table", same-key-is-true=true, namespace="Base_All", table-name="L")@
...
local C = LibStub("AceLocale-3.0"):NewLocale("SOCD_Classic", "ruRU", false, debug)

	if C then

--@localization(locale="ruRU", format="lua_additive_table", same-key-is-true=true, namespace="Classic", table-name="C")@
...
local BC = LibStub("AceLocale-3.0"):NewLocale("SOCD_BC", "ruRU", false, debug)

	if BC then

--@localization(locale="ruRU", format="lua_additive_table", same-key-is-true=true, namespace="BC", table-name="BC")@
...
local LK = LibStub("AceLocale-3.0"):NewLocale("SOCD_LK", "ruRU", false, debug)

	if LK then

--@localization(locale="ruRU", format="lua_additive_table", same-key-is-true=true, namespace="Wrath", table-name="LK")@
...
local GT = LibStub("AceLocale-3.0"):NewLocale("SOCD_GossipText", "ruRU", false, debug)
	if GT then

--@localization(locale="ruRU", format="lua_additive_table", same-key-is-true=true, namespace="GossipTexts", table-name="GT")@
