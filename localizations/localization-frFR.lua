...
local L = LibStub("AceLocale-3.0"):NewLocale(addonName, "frFR", true, debug)

if L then

--@localization(locale="frFR", format="lua_additive_table", same-key-is-true=true, handle-subnamespaces="none", table-name="L")@

end

local GT = LibStub("AceLocale-3.0"):NewLocale(addonName.."GossipText", "frFR", true, debug)
	if GT then

--@localization(locale="frFR", format="lua_additive_table", same-key-is-true=true, namespace="GossipText", table-name="GT")@
