...
--@localization(locale="zhTW", format="lua_additive_table", same-key-is-true=true, handle-subnamespaces="none", table-name="L")@
...
local C = LibStub("AceLocale-3.0"):NewLocale("SOCD_Classic", "zhTW", false)
...
local BC = LibStub("AceLocale-3.0"):NewLocale("SOCD_BC", "zhTW", false)
...
local LK = LibStub("AceLocale-3.0"):NewLocale("SOCD_LK", "zhTW", false)
...
local GT = LibStub("AceLocale-3.0"):NewLocale("SOCD_GossipText", "zhTW", false)
	if GT then
