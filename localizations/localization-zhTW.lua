...
local L = LibStub("AceLocale-3.0"):NewLocale("SOCD_Core", "zhTW", false)
...
--@localization(locale="zhTW", format="lua_additive_table", same-key-is-true=true, namespace="Base_All", table-name="L")@
...
local C = LibStub("AceLocale-3.0"):NewLocale("SOCD_Classic", "zhTW", false, debug)

	if C then

--@localization(locale="zhTW", format="lua_additive_table", same-key-is-true=true, namespace="Classic", table-name="C")@
...
local BC = LibStub("AceLocale-3.0"):NewLocale("SOCD_BC", "zhTW", false, debug)

	if BC then

--@localization(locale="zhTW", format="lua_additive_table", same-key-is-true=true, namespace="BC", table-name="BC")@
...
local LK = LibStub("AceLocale-3.0"):NewLocale("SOCD_LK", "zhTW", false, debug)

	if LK then

--@localization(locale="zhTW", format="lua_additive_table", same-key-is-true=true, namespace="Wrath", table-name="LK")@
...
local GT = LibStub("AceLocale-3.0"):NewLocale("SOCD_GossipText", "zhTW", false, debug)
	if GT then

--@localization(locale="zhTW", format="lua_additive_table", same-key-is-true=true, namespace="GossipTexts", table-name="GT")@
